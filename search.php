...
ini_set('error_log', 'error_log'); // Ensure errors go to error_log file
...
} elseif (!$domainName || !$extension) {
    $error = "Invalid domain format. Use the format 'example.com'.";
} else {
    try {
        ...
        $error = "Database error: Unable to check domain availability.";
